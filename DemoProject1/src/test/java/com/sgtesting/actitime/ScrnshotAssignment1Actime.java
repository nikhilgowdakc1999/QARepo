...
public class ScrnshotAssignment1Actime {
	...
	private static void login(String User,String pwd)
	{
		try
		{
			...
			Thread.sleep(3000);
			String Filename="D:\\New folder\\EXAMPLE\\Homepage3.png";
			captureScrnshotDemo(oBrowser,Filename);
	...
	private static void captureScrnshotDemo(WebDriver oBrowser,String destFile)
	{
		try
		{
			//
			TakesScreenshot obj=(TakesScreenshot) ScrnshotAssignment1Actime.oBrowser;
